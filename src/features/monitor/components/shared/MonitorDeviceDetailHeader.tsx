...
export default function MonitorDeviceDetailHeader({ device, onBack, lastTs, recordCount, lastVoltage, lastTemp, lastMotion, lastGwCount, range, onRangeChange, onLoadMore, hasMore }: Props) {
      ...
      <div className="flex items-center gap-4 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          {lastTs ? (
            ...
            <span className="text-text-300 text-[13px]">—</span>
          )}
        </div>
        {lastVoltage != null && (
          <>

...
import { IconSearch, IconServer, IconWifi, IconMapPin, IconDatabase, IconCloud, IconAlertTriangle } from "@tabler/icons-react";
...
export default function MonitorDeviceList({
  ...
  filteredDevices, allDevices, onSelectDevice,

...
export const useMonitorDeviceTelemetryHistory = (deviceId: number | null, params?: { from?: string; to?: string; limit?: number }) => useQuery({ queryKey: [...KEYS.all, "telemetry-history", deviceId, params], queryFn: () => monitorService.getDeviceTelemetry(deviceId!, params), enabled: !!deviceId });
